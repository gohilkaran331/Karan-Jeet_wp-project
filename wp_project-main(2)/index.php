        ...
        <nav class="nav-bar">
            ...
            <div class="menu-bar">
                <ul>
                    ...
                    <li><a href="login.html">Modify</a></li>
                    <li><a href="../wp_project-main/html/about.html">About</a></li>
                    <li><a href="../wp_project-main/html/contact.html">Contact</a></li>
                </ul>
            </div>
        </nav>
        <!-- Search Bar -->
        ...
        <div class="card-grid" >
            ...
            while($rows=$result->fetch_assoc()){
                echo '<div class="card card-shadow">';
                    echo '<div class="card-header card-image">';
                    echo "<img src='../img/" . $rows['file1'] . "' alt='Recipe Image'>";
                    echo '</div>';
                    echo '<div class="card-body" >';
                    echo '<h2>' . $rows['dishName'] . '</h2>';
                    echo '</div>';
                    echo '<div class="card-footer">';
                    echo '<button class="btn" onclick="getRecipeDetails1()">Get Recipe</button>';
                    echo '</div>';
                echo "</div>";
            }
	...
	?>
                    <div class="card card-shadow">
                        <div class="card-header card-image">
                            <img src="../wp_project-main/img/Sisig.webp">
                        </div>
                        <div class="card-body" >
                        <h3> Sisig </h3>
                        </div>
                    ...
                    <div class="card card-shadow">
                        <div class="card-header card-image">
                            <img src="../wp_project-main/img/Adobo.webp">
                        </div>
                        <div class="card-body" >
                        <h3> Adobo </h3>
                        </div>
                    ...
                    <div class="card card-shadow">
                        <div class="card-header card-image">
                            <img src="../wp_project-main/img/Porkchop.webp">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card card-shadow">
                        <div class="card-header card-image">
                            <img src="../wp_project-main/img/Omelette.webp">
                        </div>
                        <div class="card-body" >
                            <h3>Omelette</h3>
                        </div>
                    ...
                    <div class="card card-shadow">
                        <div class="card-header card-image">
                            <img style="max-height: 200px; object-position: center;" src="../wp_project-main/img/red_dish.jpg">
                        </div>
                        <div class="card-body" >
...
<script src="../wp_project-main/js/index.js"></script>
<script>
